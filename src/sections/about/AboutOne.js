                          ...
                          <Carousel breakPoints={breakPoints}>
                                    ...
                                    <div className="card">
                                        <div className="info">
                                            ...
                                            <div className="bio">
                                            Nosso plano odontológico te oferece o que há de mais tecnológico e inovador em tratamento dentário!
                                    ...
                                    <div className="card">
                                        <div className="info">
                                            ...
                                            <div className="divider"></div>
                                            <div className="bio">
                                            Com hospitais e laboratórios próprios, entregamos o melhor pra você! 
                                            </div>
                                            <a href='#SIMULAR' className="button">SIMULAR</a>
                                        </div>
